...
const rawData = [
  {
    ...
    "calories": null, "desc": null, "protein": null, "rating": null,
...
function processAndReplace() {
  const outputPath = path.join(__dirname, '../data/recipes.json');
  
  // We'll read the full raw array if stored or process rawData array
  console.log("Replacing backend/data/recipes.json dataset...");
}
